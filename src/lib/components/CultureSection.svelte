...
<section class="py-24 px-6 md:px-12 bg-white">
  <div class="max-w-2xl mb-16">
    <p class="text-xl md:text-2xl leading-relaxed text-gray-800">
      We understand that mid-market companies need reliable technology but often lack internal IT resources. That's why we become an extension of your team, providing expertise and support when you need it most.
    </p>
  </div>
